...
class AuthServiceProvider extends ServiceProvider
{
     ...
     */
    protected $policies = [ // @phpstan-ignore-line
    ...
    public function boot()
    {
        ...
        $this->app->bind(\App\Contracts\Auth\Auth::class, \App\Services\Auth\Auth::class);
        ...
        $this->app->bind(\App\Contracts\Auth\VerifyEmail::class, \App\Services\Auth\VerifyEmail::class);
