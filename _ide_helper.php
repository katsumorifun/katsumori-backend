 ...
 */
     ...
     */ 
         ...
         * 
         *
         * @see \ALajusticia\AuthTracker\Macros\RouteMacros::authTracker()
         * @param mixed $prefix
         * @static 
         */ 
        public static function authTracker($prefix)
        {
                        return \Illuminate\Routing\Router::authTracker($prefix);
        }
...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function checkPermission($role_id, $permission)
        {
                        /** @var \App\Services\Access\Roles $instance */
                        return $instance->checkPermission($role_id, $permission);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Services\Access\Roles $instance */
                        return $instance->getRole($role_id);
        }
     ...
     */ 
         ...
         * 
         *
         * @see \ALajusticia\Expirable\Macros\BlueprintMacros::expirable()
         * @param mixed $columnName
         * @static 
         */ 
        public static function expirable($columnName = null)
        {
                        return \Illuminate\Database\Schema\Blueprint::expirable($columnName);
        }
                    /**
         * 
         *
         * @see \ALajusticia\Expirable\Macros\BlueprintMacros::dropExpirable()
         * @param mixed $columnName
         * @static 
         */ 
        public static function dropExpirable($columnName = null)
        {
                        return \Illuminate\Database\Schema\Blueprint::dropExpirable($columnName);
        }
...
namespace  { 
            ...
            class access extends \App\Support\Facades\Access {}
