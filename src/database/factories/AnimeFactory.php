...
class AnimeFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'synopsis_ru_author_url'      => 'https://shikimori.one/',
            'synopsis_en_author_url'      => 'https://shikimori.one/',
            'synopsis_en_author'          => 'Shikimori',
            'synopsis_ru_author'          => 'Shikimori',
            ...
            'image_x96'                   => '/x32/'.$this->faker->name.'.png',
            'image_x48'                   => '/x64/'.$this->faker->name.'.png',
            'image_preview'                  => '/x128/'.$this->faker->name.'.png',
