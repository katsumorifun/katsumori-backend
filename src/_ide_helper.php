 ...
 */
     ...
     */
        ...
        public static function deliverVia($channel)
        {
                    ...
                    /**
         * Set the locale of notifications.php.
         *
         * @param string $locale
        ...
        public static function assertNotSentTo($notifiable, $notification, $callback = null)
        {
                    ...
                    /**
         * Assert that no notifications.php were sent.
         *
         * @return void
         * @static
         */
        public static function assertNothingSent()
        {
                    ...
                    /**
         * Assert that no notifications.php were sent to the given notifiable.
         *
         * @param mixed $notifiable
         * @return void
         * @throws \Exception
        ...
        public static function assertTimesSent($expectedCount, $notification)
        {
                    ...
                    /**
         * Get all of the notifications.php matching a truth-test callback.
         *
         * @param mixed $notifiable
         * @param string $notification
         * @param callable|null $callback
        ...
        public static function sent($notifiable, $notification, $callback = null)
        {
                    ...
                    /**
         * Determine if there are more notifications.php left to inspect.
         *
         * @param mixed $notifiable
         * @param string $notification
         * @return bool
