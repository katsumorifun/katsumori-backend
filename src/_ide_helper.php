...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function update($user, $image)
        {
                        /** @var \App\Services\Images\Avatar $instance */
                        return $instance->update($user, $image);
        }
...
namespace  { 
            ...
            class avatar extends \App\Services\Images\Facade\Avatar {}
