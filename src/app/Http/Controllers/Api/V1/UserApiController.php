...
class UserApiController extends ApiController
{
     ...
     *     path="/devices",
     *     tags = {"Devices"},
     *     summary="Отображение списка устройств, с которых был выполнен вход в учетную заапись",
     *     description="Отображение всех устройств, с которых был выполнен вход в учетную заапись",
     *     security={
     *       {"Authorization": {}},
     *     },
     *
